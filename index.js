...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        gameCard.innerHTML = `
            ...
            <div class="progress-bar" style="width: ${Math.min(100, (games[i].pledged / games[i].goal) * 100)}%"></div>
            </div>
            <p>${games[i].backers.toLocaleString()} backers</p>
        `;
...
const displayStr = `A total of $${totalRaised.toLocaleString()} 
                    ...
                    ${numUnfundedGames} ${numUnfundedGames === 1 ? 'game remains' : 'games remain'} unfunded. 
...
/* Customizations */
// Add a search input and function
...
buttonContainer.parentNode.insertBefore(searchContainer, buttonContainer);
...
navBar.innerHTML = `
  <ul>
    <li><a href="#description-container">About</a></li>
    <li><a href="#top-games">Top Games</a></li>
    <li><a href="#games-container">All Games</a></li>
  </ul>
`;
